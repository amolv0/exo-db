...
def update_skills_rankings(team_id, season, skill_type, rank):
    try:
        ...
        print(f"Updated team skills rank for team {team_id} for type: {skill_type}, season {season}")
        ...
        print(f"Created team skills rank object for team {team_id} for type: {skill_type}, season {season}")
        ...
        if e.response['Error']['Code'] == 'ValidationException':
            ...
            print(f"Updated team skills rank for team {team_id} for type: {skill_type}, adding a new season {season}")
        else: print(f"Error updating team skills rank for team exception 1: {team_id}: {e}")
    except Exception as e:
        print(f"Error updating team skills rank for team: {team_id}: {e}")
...
def update_skills_regional_rankings(team_id, season, skill_type, rank):
    try:
        ...
        print(f"Updated team skills regional rank for team {team_id} for type: {skill_type}, season {season}")
    except team_table.meta.client.exceptions.ConditionalCheckFailedException:
        ...
        print(f"Created team skills regional rank for team {team_id} for type: {skill_type}, season {season}")
    except ClientError as e:
        if e.response['Error']['Code'] == 'ValidationException':
            response = team_table.update_item(
                Key={'id': team_id},
            ...
            print(f"Updated team skills regional rank for team {team_id} for type: {skill_type}, adding a new season {season}")
        else: print(f"Error updating team skills rank for team exception 1: {team_id}: {e}")
    except Exception as e:
        print(f"Error updating team skills regional rank for team: {team_id}: {e}")
...
def delete_skills_rankings_for_and_teams(team_id):
    try:
        ...
        print(f"Removed skills_rankings from team {team_id}")
    except Exception as e:
        print(f"Error removing skills_rankings for team {team_id}: {e}")
