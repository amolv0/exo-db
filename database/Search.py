...
def search_opensearch(queryTerm):
    # OpenSearch endpoint
    url = 'OPENSEARCH_API_ENDPOINT/search-index/_search'
...
# Example usage
queryTerm = "2024 Washington VRC High School Regional Championship"  # This is the programmatically assigned query term
