...
interface TeamEventDisplayProps {
  eventIdsString: string | null;
}

const TeamEventDisplay: React.FC<TeamEventDisplayProps> = ({ eventIdsString }) => {
...
export default TeamEventDisplay;