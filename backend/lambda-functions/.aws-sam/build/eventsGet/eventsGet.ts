...
const buildQueryParams = (startDate?: string, numberOfEvents = 10, eventCode?: string, eventLevel?: string, isBefore?: boolean) => {
    const params: any = {
        TableName: 'event-data',
...
const getEventsByRegion = async (region: string, startDate?: string, numberOfEvents = 10, eventCode?: string, eventLevel?: string, isBefore?: boolean) => {
    let accumulatedItems: number[] = [];
    let lastEvaluatedKey = undefined;
...
const getEventsByCountry = async (regions: string[], startDate?: string, numberOfEvents = 10, eventCode?: string, eventLevel?: string, isBefore?: boolean) => {
    let accumulatedItems: number[] = [];
    let lastEvaluatedKey = undefined;
